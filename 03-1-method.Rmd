...
Diagnostic data was obtained from Landspitali University Hospital's inpatient registry and the Primary Care Registry of the Directorate of Health. 
...
### Landspitali University Hospital inpatient registry {#inpatientregistry}
...
Several smaller independent data-sets pertaining to specific papers were extracted from the inpatient registry.
...
Data from the inpatient registry was used in [paper I](#paper1), [paper IV](#paper4), [paper V](#paper5) and [paper VI](#paper6).
