...
During the study period from 1 January 2005 to 31 December 2017, data were collected from multiple whole population registries, and from a single hospital registry. 
All data were identifiable to individuals by government issued national identification numbers.
...
The data underlying this study was observational in nature, and its quality was enhanced by several factors.
...
For the period from 1 January 2005 to 31 December 2017, data were extracted on all unplanned acute-care visits and hospital admissions with ICD-10 discharge diagnoses compatible with respiratory infections (Table \@ref(tab:table-icd)).
...
All costs were recorded in Icelandic kronas (ISK) and was broken down into specific subsets.
Costs associated with diagnostic testing were provided and broken down into costs associated with chemical blood testing; diagnostic radiological testing; anatomical pathology; virological testing; bacteriological cultures; antibody and other immunological testing; and specific tests performed by the blood bank in preparation for the administration of blood products.
...
The costs associated with treatment were broken down into the cost of drugs, surgery and procedures and intensive care unit treatment. 
...
[Paper VI](#paper6) -- a cost-benefit analysis of PHiD-CV10 introduction into the pediatric vaccination program, required synthetic controls used within a time-series analysis framework. 
...
kable(
    ...
    caption = "The International Classification of Diseases, 10th revision subchapters used to define synthetic conrtrols"
    )
...
kable(
    ...
    caption = "Anatomical Therapeutic Chemical (ATC) codes used for individual-level data collection from the National Drug Prescription Registry. The presents ATC codes down to the therapeutic level. All sublevels of the listed ATC codes were also included. ATC codes J07 and sublevels were used to extract data on pneumococcal vaccine doses from the National Vaccine Registry."
    )
```
...
There are exceptions to this -- for example, visits by children under two years of age are completely covered by the insurance. 
