...
(ref:figure22) Kaplan-Meier cumulative event curves per 1,000 person-years for each of the diagnostic groups are displayed in panels A-F. The vaccine non-eligible cohorts (VNEC) are illustrated in red and the vaccine eligible cohorts (VEC) in blue. The presence of censored observations is indicated with a cross and the 95% confidence intervals are represented with a shaded area. The Y-axis is scaled independently for each pair of diagnostic groups (A-B, C-D and E-F).
