...
The ICER from the societal perspective was 59\$ (95% credible interval -1\$ to 207\$) per prevented AOM case, assuming the vaccine did not result in any benefit in other manifestations of pneumococcal infections.
When cost-savings due to reductions in hospital admissions for pneumonia and invasive pneumococcal disease were also included, the direct cost of the PHiD-CV10 introduction was -6,722,048\$ (95% credible intervals -14,263,736\$ to -528,526\$) as of 31 December 2015.
From the health sector perspective, the vaccination program was already cost-saving 6,722,048\$ in the first five years of the program.
The corresponding ICER was -488\$ (95% credible interval -1,307\$ to -41\$) per prevented AOM case.
When days of work lost due to hospitalized pneumonia and IPD cases were also included, the total cost of including PHiD-CV10 in the pediatric vaccination program was -7,404,352\$ (95% credible interval -15,315,132\$ to 981,925\$) as of 31 December 2015.
The corresponding ICER was -541\$ (95% credible interval -1,404\$ to 79\$) per AOM case prevented. 
...
If the vaccine is assumed to have no other benefits than preventing pneumonia hospitalizations, and only the direct costs are considered, the ICER was -4,654\$ (95% credible interval -7,722\$ to 711\$) per prevented pneumonia hospitalization, indicating a net savings of 4,654\$ for each prevented hospitalization from the health sector perspective.
...
From the societal perspective, the ICER was -5,085\$ (95% credible interval -8,186\$ to 191\$) per prevented pneumonia hospitalization, assuming no other vaccine benefit, which implies that the society gains 5,085\$ for every pneumonia hospitalization prevented by investing in PHiD-CV10.
If the vaccination program's effects on the other manifestations of pneumococcal disease were also included, then the ICER was -5,640\$ (95% credible interval -10,336\$ to -1,032\$) from the health sector perspective as of 31 December 2015.
Including also loss of work resulted in an ICER of -6,309\$ (95% credible interval -11,055\$ to -1,809\$). 
...
If the vaccine was assumed to have no other benefits than preventing IPD hospitalizations, and only the direct costs are considered, the ICER was 26,424\$ (95% credible interval 7,289\$ to 71,025\$) per prevented IPD hospitalization.
...
If the vaccine was assumed to have no other benefits than preventing IPD hospitalizations, the ICER from the societal perspective was 25,911\$ (95% credible intervals 7,263\$ to 69,974\$) per prevented IPD hospitalization.
When cost-savings due to reductions in AOM visits or hospital admissions for pneumonia were also included, the ICER was -105,548\$ (95% credible interval -340,574\$ to -7,793\$) per prevented IPD hospitalization from the health sector perspective.
When days of work lost were also considered, the ICER was -116,809 (95% credible interval -367,085\$ to -14,438\$) per prevented IPD hospitalization. 
