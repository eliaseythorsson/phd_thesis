...
The data presented in this thesis were collected and analysed over a four year period from 2013-2017, and consequently, the papers that form this thesis were written and published at different times.
...
The number of visits and hospitalizations corresponding to each of the study's ICD-10 codes recorded as the primary diagnosis, are shown in Table \@ref(tab:table-icd10-results).
