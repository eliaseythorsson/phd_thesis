...
The data presented in this thesis was collected and analysed over a four year period from 2013-2017.
...
Statistics Iceland (www.statice.is) provided data on immigration and emigration of all Icelandic children zero to four years of age from 2005-2017.
...
kable(
    ...
    caption = "The number of NOMESCO Classification of Surgical Procedures (NCSP) performed at Landspitali University Hospital between 1 January 2005 and 31 December 2017. The presented data is for all age-groups",
    format.args = list(big.mark = ",")
    )
```
...
```{r vaccine-time, fig.cap = "(ref:figure2)"}
