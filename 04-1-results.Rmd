...
Though children and young adults contribute the most number of visits due to study diagnoses, older adults contribue the largest number of hospitalizations. 
...
The numer of contacts by age can be seen in Figure \@ref(fig:density-age).
...
knitr::kable(
    ...
    ungroup() %>%
    count(birth_y, dose) %>%
    spread(key = birth_y, value = n),
    col.names = c("No. of doses", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015"),
...
```
Some children in vaccine non-eligible cohorts received one, two or three doses of pneumococcal conjugate vaccines before four years of age, but generally did so inconsistently and at an older age Figure \@ref(fig:vaccine-age).
