source("_scripts/paper_6/paper_6_ipd_vaccinetype/paper_6_ipd_vaccinetype_synthetic_control_functions.R", local = T)

input_directory  <- "_data/paper_6/paper_6_ipd_vaccinetype/" # Directory (or URL) containing input data file.
file_name <- "input-data.csv"
output_directory <- '_analyses/paper_6/paper_6_ipd_vaccinetype/Results'   # Directory where results will be saved.
...
impact_full <- read_rds("_analyses/paper_6/paper_6_ipd_vaccinetype/Results_paper_6_ipd_vaccinetype_2019-03-11-213809/paper_6_ipd_vaccinetype_synthetic_control_model.rds")
impact_stack <- read_rds("_analyses/paper_6/paper_6_ipd_vaccinetype/Results_paper_6_ipd_vaccinetype_2019-03-11-213809/paper_6_ipd_vaccinetype_stacked_model.rds")


# set theme for ggplot2 figures
theme_set(theme_bw(base_size = 10, base_family = "sans"))

ipd_vaccinetype_number <- prelog_data %>% 
    mutate(
        date = as.Date(date),
...
ipd_vaccinetype_standard <- prelog_data %>% 
    mutate(
        date = as.Date(date),
        age_group = fct_relevel(
            age_group, "0-4y", "5-64y", "65y+")
...
ipd_vaccinetype_arranged_paper6 <- ggarrange(
    plotlist = list(
        ipd_vaccinetype_number,
        ipd_vaccinetype_standard,
        else_standard),
    ncol = 1,
    nrow = 3,
    labels = c("A", "B", "C"),
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-ipd-vaccinetype-arranged.pdf"), 
    plot = ipd_vaccinetype_arranged_paper6,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-ipd-vaccinetype-arranged.png"),
    plot = ipd_vaccinetype_arranged_paper6,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-predict-models.pdf"), 
    plot = predict_models,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-predict-models.png"),
    plot = predict_models,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-stacked-models.pdf"), 
    plot = stacked_models,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-stacked-models.png"),
    plot = stacked_models,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-rolling-rate.pdf"), 
    plot = rolling_rate,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-rolling-rate.png"),
    plot = rolling_rate,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-cum-arranged.pdf"), 
    plot = arranged_cum_prevented,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd_vaccinetype/", Sys.Date(), "-cum-arranged.png"),
    plot = arranged_cum_prevented,
    width = 12, height = 14, units = "cm", dpi = 600)
