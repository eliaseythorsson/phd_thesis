...
iceland <- read_excel(
    "_data/paper_6/paper_6_ipd_nonvaccinetype/synthetic-controls-ipd.xls", 
    sheet = "Gögnin",
...
sykl <- read_excel("_data/paper_6/paper_6_ipd_nonvaccinetype/Ífarandi pneumo_1995_2016_Elias.xls")
...
sykl <- sykl %>%
    filter(date >= as.Date("2005-01-01"), date <= as.Date("2017-12-31"), vac_t == 0) %>%
    mutate(
...
write_csv(path = "_data/paper_6/paper_6_ipd_nonvaccinetype/input-data.csv", x = iceland)
