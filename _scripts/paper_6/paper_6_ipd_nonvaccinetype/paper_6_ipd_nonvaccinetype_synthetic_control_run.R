...
country       <- 'paper_6_ipd_nonvaccinetype' # Country or region name.
...
source('_scripts/paper_6/paper_6_ipd_nonvaccinetype/paper_6_ipd_nonvaccinetype_synthetic_control_report.R', local = TRUE)
source('_scripts/paper_6/paper_6_ipd_nonvaccinetype/paper_6_ipd_nonvaccinetype_synthetic_control_write_results.R', local = TRUE) #save .csv files with output tables
