...
country       <- 'paper_6_uti_outpatient' # Country or region name.
n_seasons     <- 12       # Number of months (seasons) per year. 12 for monthly, 4 for quarterly, 3 for trimester data.
exclude_covar <- c("Z00_Z99", "A10_B99", "R00_R99", "U00_U99", "K80", "I60_I64", "E86", "E40_E46", "E10_E14", "N00_N99") # User-defined list of covariate columns to exclude from all analyses.
...
output_directory <- '_analyses/paper_6/paper_6_uti_outpatient/Results'   # Directory where results will be saved.
...
source('_scripts/paper_6/paper_6_uti_outpatient/paper_6_uti_outpatient_synthetic_control_report.R', local = TRUE)
source('_scripts/paper_6/paper_6_uti_outpatient/paper_6_uti_outpatient_synthetic_control_write_results.R', local = TRUE) #save .csv files with output tables
