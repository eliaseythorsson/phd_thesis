...
country       <- 'paper_6_otitis_media_antimicrobials' # Country or region name.
...
input_directory  <- "_data/paper_6/paper_6_otitis_media_antimicrobials/" # Directory (or URL) containing input data file.
file_name <- "input-data.csv"
output_directory <- '_analyses/paper_6/paper_6_otitis_media_antimicrobials/Results'   # Directory where results will be saved.
