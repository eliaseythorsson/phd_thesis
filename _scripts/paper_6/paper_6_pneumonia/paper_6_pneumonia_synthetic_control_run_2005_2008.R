...
country       <- 'paper_6_pneumonia_2005_2008' # Country or region name.
...
post_period       <- as.Date(c('2009-01-01', '2017-12-01')) # Range from the intervention date to the end date.
