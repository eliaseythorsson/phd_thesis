...
country       <- 'paper_6_pneumonia_J13_J18' # Country or region name.
...
input_directory  <- "_data/paper_6/paper_6_pneumonia_J13_J18/" # Directory (or URL) containing input data file.
file_name <- "input-data.csv"
output_directory <- '_analyses/paper_6/paper_6_pneumonia_J13_J18/Results'    # Directory where results will be saved.
