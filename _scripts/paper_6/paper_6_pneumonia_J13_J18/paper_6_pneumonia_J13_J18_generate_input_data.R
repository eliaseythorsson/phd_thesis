...
iceland <- read_excel(
    "_data/paper_6/paper_6_pneumonia_J13_J18/synthetic-controls-pneumonia.xls", 
    sheet = "Gögnin",
...
lsh <- 
    ...
    mutate(
        ...
        age_group = case_when(
            ...
            TRUE ~ "remove"),
        group = case_when(
            str_detect(string = icd10_code, pattern = "J13|J15.8|J15.9|J18.1|J18.8|J18.9") ~ "J13_18",
...
write_csv(path = "_data/paper_6/paper_6_pneumonia_J13_J18/input-data.csv", x = iceland)
