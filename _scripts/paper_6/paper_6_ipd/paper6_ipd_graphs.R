...
impact_full <- read_rds("_analyses/paper_6/paper_6_ipd/Results_paper_6_ipd_2018-12-04-192314/paper_6_ipd_synthetic_control_model.rds")
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-ipd-arranged.pdf"), 
    plot = ipd_arranged_paper6,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-ipd-arranged.png"),
    plot = ipd_arranged_paper6,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-predict-models.pdf"), 
    plot = predict_models,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-predict-models.png"),
    plot = predict_models,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-stacked-models.pdf"), 
    plot = stacked_models,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-stacked-models.png"),
    plot = stacked_models,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-rolling-rate.pdf"), 
    plot = rolling_rate,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-rolling-rate.png"),
    plot = rolling_rate,
    width = 12, height = 14, units = "cm", dpi = 600)
...
ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-cum-arranged.pdf"), 
    plot = arranged_cum_prevented,
    width = 12, height = 14, units = "cm", dpi = 600)

ggsave(
    filename = paste0("_figures/paper_6/paper_6_ipd/", Sys.Date(), "-cum-arranged.png"),
    plot = arranged_cum_prevented,
    width = 12, height = 14, units = "cm", dpi = 600)
