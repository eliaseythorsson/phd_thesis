...
country       <- 'paper_6_otitis_media_2005_2009' # Country or region name.
...
pre_period        <- as.Date(c('2005-01-01', '2009-12-31')) # Range over which the data is trained for the CausalImpact model.
post_period       <- as.Date(c('2010-01-01', '2015-12-01')) # Range from the intervention date to the end date.
