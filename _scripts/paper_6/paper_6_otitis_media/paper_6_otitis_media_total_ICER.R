...
ICER_direct <- c(ICER_direct_cost_all, cumsum_direct_cost_all_ipd, cumsum_direct_cost_all_pneumonia)
...
## Combine all of the above into one list
ICER_total <- c(ICER_cost_all, cumsum_cost_all_ipd, cumsum_cost_all_pneumonia)
...
saveRDS(object = total_prevented_direct_costs, file = '_analyses/paper_6/paper_6_otitis_media/total_prevented_direct_costs')
saveRDS(object = total_prevented_costs, file = '_analyses/paper_6/paper_6_otitis_media/total_prevented_costs')
saveRDS(object = ICER_direct, file = '_analyses/paper_6/paper_6_otitis_media/ICER_direct')
saveRDS(object = ICER_total, file = '_analyses/paper_6/paper_6_otitis_media/ICER_total')