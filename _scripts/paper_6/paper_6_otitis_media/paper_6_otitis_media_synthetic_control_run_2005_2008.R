...
country       <- 'paper_6_otitis_media_2005_2007' # Country or region name.
...
intervention_date <- as.Date('2008-12-31') # Indicates the date of intervention in the data.
end_date          <- as.Date('2015-12-01') # Indicates the date of the last data point.
pre_period        <- as.Date(c('2005-01-01', '2008-12-31')) # Range over which the data is trained for the CausalImpact model.
post_period       <- as.Date(c('2009-01-01', '2015-12-01')) # Range from the intervention date to the end date.
