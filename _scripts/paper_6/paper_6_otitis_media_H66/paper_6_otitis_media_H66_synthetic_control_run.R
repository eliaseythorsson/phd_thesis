...
country       <- 'paper_6_otitis_media_H66' # Country or region name.
...
input_directory  <- "_data/paper_6/paper_6_otitis_media_H66/" # Directory (or URL) containing input data file.
file_name <- "input-data.csv"
output_directory <- '_analyses/paper_6/paper_6_otitis_media_H66/Results'   # Directory where results will be saved.
...
outcome_name <- 'H66'    # Name of column containing outcome.
