...
country       <- 'paper_6_uti_inpatient' # Country or region name.
n_seasons     <- 12       # Number of months (seasons) per year. 12 for monthly, 4 for quarterly, 3 for trimester data.
exclude_covar <- c("N00.99") # User-defined list of covariate columns to exclude from all analyses.
...
output_directory <- '_analyses/paper_6/paper_6_uti_inpatient/Results'   # Directory where results will be saved.
...
source('_scripts/paper_6/paper_6_uti_inpatient/paper_6_uti_inpatient_synthetic_control_report.R', local = TRUE)
source('_scripts/paper_6/paper_6_uti_inpatient/paper_6_uti_inpatient_synthetic_control_write_results.R', local = TRUE) #save .csv files with output tables
